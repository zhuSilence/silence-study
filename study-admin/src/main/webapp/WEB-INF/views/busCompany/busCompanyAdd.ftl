    ...
    <div class="opt-content">
        ...
        <form id="form" class="form-horizontal">
            <div class="form-group"><label class="col-sm-2 control-label">中文名称</label>
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" v-model.trim="companyEnglishName" data-validation="  length"
            ...
            <div class="form-group"><label class="col-sm-2 control-label">公司地址</label>
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" v-model.trim="address" data-validation=" required length"
            ...
            <div class="form-group"><label class="col-sm-2 control-label">法定代表人</label>
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" v-model.trim="legalPerson" data-validation="  length"
                           data-validation-length="max50">
                </div>
                <label class="col-sm-2 control-label">注册地</label>

                <div class="col-sm-4">
                    <input type="text" class="form-control" v-model.trim="registerAdd" data-validation="  length"
                           data-validation-length="max100">
                </div>
            </div>
            <div class="form-group"><label class="col-sm-2 control-label">注册号</label>
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" v-model.trim="registerNumber" data-validation="  length"
                           data-validation-length="max50">
                </div>
                <label class="col-sm-2 control-label">注册资本</label>

                <div class="col-sm-4">
                    <input type="number" class="form-control" v-model.trim="registerMoney" style="width: 200px;"
                           value="0">
                </div>
            </div>
            <div class="form-group"><label class="col-sm-2 control-label">公司官网</label>
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" v-model.trim="officialWebsite"
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" v-model.trim="contactPerson" data-validation="  length"
                           data-validation-length="max50">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" v-model.trim="contactPhone" data-validation="  length"
