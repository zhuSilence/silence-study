            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="roleRemark" data-validation="  length"
                                   data-validation-length="max30">
                        </div>
                    </div>
                </div>
...
<#include '../foot.ftl'/>
<script src="${urls.StaticPath}/static/js/view/sysRole/sysRoleAdd.js"></script>
</html>