...
public class Constant {
	...
	/** 根目录 **/
	public final String UPLOAD_ROOT = propertiesUtils.get("upload.root");
	/** URL前缀 **/
	public final String UPLOAD_URL = propertiesUtils.get("upload.url");
	/** 上传文件路径 **/
	public final String UPLOAD_PATH = propertiesUtils.get("upload.path");
	/** 上传图片大小 **/
	public final String UPLOAD_PIC_SIZE = propertiesUtils.get("upload.pic.size");
